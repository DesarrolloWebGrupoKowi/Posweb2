    ...
    */
    ...
    'connections' => [
        ...
        'Cloud_Tables' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_CLOUD_TABLES', 'localhost'),
            'port' => env('DB_PORT_CLOUD_TABLES', '1433'),
            'database' => env('DB_DATABASE_CLOUD_TABLES', 'forge'),
            'username' => env('DB_USERNAME_CLOUD_TABLES', 'forge'),
            'password' => env('DB_PASSWORD_CLOUD_TABLES', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
        ],
        ...
        'server4.3' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_server4.3', 'localhost'),
            'port' => env('DB_PORT_server4.3', '1433'),
            'database' => env('DB_DATABASE_server4.3', 'forge'),
            'username' => env('DB_USERNAME_server4.3', 'forge'),
            'password' => env('DB_PASSWORD_server4.3', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
        ],
