...
class PedidosController extends Controller
{
    public function Pedidos()
    {
        ...
        return view('Pedidos.Pedidos', compact('datPedidos', 'sumImporte', 'sumIva', 'total', 'banderaEnabled', 'fechaHoy', 'manana', 'tienda'));
    }
    ...
    public function DatPedidos(Request $request)
    {
        ...
        if ($inicio != '200') {
            ...
            if (empty($articulo)) {
                return redirect('Pedidos')->with('AlertPedido', 'Etiqueta mal escrita!');
            }
            ...
            if ($articulo->Peso != 0) {
                ...
                if ($articuloPrecio->PrecioArticulo == 0) {
                    return redirect('Pedidos')->with('AlertPedido', 'El Articulo ' . $articulo->NomArticulo . ' No Tiene Precio Asignado, Comuniquese Con El Gerente!');
                ...
                return redirect('Pedidos')->with('AlertPedido', 'El articulo ' . $articulo->NomArticulo . ' no tiene peso fijo comuniquese con el Gerente!');
            ...
            if ($peso == 0) {
                if ($articulo->Peso != 0) {
                    ...
                    return redirect('Pedidos')->with('AlertPedido', 'El articulo ' . $articulo->NomArticulo . ' no tiene peso fijo, imprima de nuevo la etiqueta ó coloque el peso!');
    ...
    public function GuardarPedido(Request $request)
    {
        ...
        return redirect('/Pedidos')->with('PedidoGuardado', 'Pedido Guardado con Exito!');
    }
