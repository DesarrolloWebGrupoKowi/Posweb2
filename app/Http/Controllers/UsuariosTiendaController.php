...
class UsuariosTiendaController extends Controller
{
    public function CatUsuariosTienda(Request $request){
        $txtUsuarioTienda = $request->get('txtUsuarioTienda');
        $usuariosTienda = DB::table('CatUsuariosTienda')
                            ...
                            ->where([
                                ['CatUsuarios.NomUsuario', 'like', '%'.$txtUsuarioTienda.'%'],
        ...
        return view('UsuariosTienda.CatUsuariosTienda', compact('usuariosTienda', 'usuarios', 'tiendas', 'plazas', 'txtUsuarioTienda'));
    }
