...
<div class="modal fade" id="ModalEditarEmpleado{{ $lCredito->IdCatLimiteCreditoEspecial }}" tabindex="-1"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control rounded" style="line-height: 18px"
                                name="NumNomina" id="NumNomina" placeholder="Número nomina"
                                value="{{ $lCredito->NumNomina }}" required>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <input type="number" class="form-control rounded" style="line-height: 18px" name="Limite"
                                id="Limite" placeholder="Limite de crédito" value="{{ $lCredito->Limite }}" required>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <input type="number" class="form-control rounded" style="line-height: 18px"
                                name="TotalVentaDiaria" id="TotalVentaDiaria" placeholder="Ventas diarias"
                                value="{{ $lCredito->TotalVentaDiaria }}" required>
                        </div>
                    </div>
                </div>
