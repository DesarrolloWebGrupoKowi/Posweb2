        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/CrearPlaza" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="NomPlaza" name="NomPlaza" class="form-control" tabindex="1" onkeyup="mayusculas(this)" required>
                        </div>
                        <div class="mb-3">
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-primary" value="Crear Plaza">
                    </form>
                </div>
            </div>
        </div>
