...
<div class="container mb-3">
    <form action="/AdeudosEmpleado">
        <div class="row">
            <div class="col-auto">
                <input class="form-control shadow" type="number" name="numNomina" placeholder="Nómina" value="{{ $numNomina }}"
                    required>
            </div>
            <div class="col-auto">
    ...
    <div class="mb-3">
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-auto bg-danger text-white shadow">
                <h5><i class="fa fa-exclamation-triangle"></i> No se Encontro el Empleado <i class="fa fa-exclamation-triangle"></i></h5>
            </div>
            @endif
