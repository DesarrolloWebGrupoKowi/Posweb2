...
<div
    class="modal fade"
    id="ModalAgregarSubTipoMerma"
    tabindex="-1"
    aria-labelledby="ModalAgregarSubTipoMermaLabel"
    aria-hidden="true"
>
    <div
        class="modal-dialog"
        ...
        >
            ...
            >
                <h5
                    ...
                    id="ModalAgregarSubTipoMermaLabel"
                >
                    <div class="d-flex align-items-center gap-3 pb-2">
                        ...
                        <span>Agregar Sub Tipo de Merma</span>
                    </div>
                </h5>
            </div>
            ...
            <div class="modal-body p-4">
                <form
                    action="/CrearSubTipoMerma/{{ $idTipoMerma }}"
                    method="POST"
                >
                    @csrf

                    <!-- Nombre Sub Tipo de Merma -->
                    <div class="mb-3">
                        <label
                            for="nomSubTipoMerma"
                        ...
                        >
                            Nombre Sub Tipo de Merma <span style="color: var(--danger-color);">*</span>
                        </label>
                        <div class="input-group">
                            ...
                            <input
                                ...
                                name="nomSubTipoMerma"
                                id="nomSubTipoMerma"
                                placeholder="Nombre Sub Tipo de Merma"
                                tabindex="1"
                                required
                            >
                        </div>
