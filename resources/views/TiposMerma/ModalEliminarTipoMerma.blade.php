...
<div
    class="modal fade"
    id="ModalEliminarArticuloTipoMerma{{ $tipoMerma->IdTipoMerma }}"
    tabindex="-1"
    aria-labelledby="ModalEliminarTipoMermaLabel{{ $tipoMerma->IdTipoMerma }}"
    aria-hidden="true"
>
    <div
        class="modal-dialog"
        ...
        >
            ...
            >
                <h5
                    ...
                    id="ModalEliminarTipoMermaLabel{{ $tipoMerma->IdTipoMerma }}"
                >
                    <div class="d-flex align-items-center gap-3 pb-2">
                        ...
                        <span>Eliminar Tipo de Merma</span>
                    </div>
                </h5>
            </div>
            ...
            <div class="modal-body p-4">
                <form
                    action="/EliminarTipoMerma/{{ $tipoMerma->IdTipoMerma }}"
                    method="POST"
                >
                    @csrf
                    ...
                    >
                        ...
                        <div>
                            <small style="color: #991b1b; font-size: 0.78rem;">
                                Esta acción eliminará permanentemente el tipo de merma y puede afectar registros
                                relacionados.
                            </small>
                        </div>
                    </div>
