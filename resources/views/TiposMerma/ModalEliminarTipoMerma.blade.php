...
<div
    ...
    tabindex="-1"
    aria-labelledby="ModalEliminarTipoMerma{{ $tipoMerma->IdTipoMerma }}Label"
    aria-hidden="true"
>
    <div class="modal-dialog modal-dialog-centered">
        ...
        >
            <div class="p-4 text-center">
                ...
                >Eliminar Tipo de Merma</h5>

                <!-- Mensaje -->
                <p style="color: var(--text-secondary); font-size: 0.85rem; margin-bottom: 8px;">
                    ¿Seguro que desea eliminar este tipo de merma?
                </p>
                <p
                ...
                <p style="color: var(--text-muted); font-size: 0.78rem; margin-bottom: 24px;">
                    Esta acción no se puede revertir y puede afectar registros relacionados.
                </p>
