...
<div
    class="modal fade"
    id="ModalAgregarTipoMerma"
    tabindex="-1"
    aria-labelledby="ModalAgregarTipoMermaLabel"
    aria-hidden="true"
>
    <div
        class="modal-dialog"
    ...
    >
        ...
        >
            ...
            >
                ...
                >
                    <div class="d-flex align-items-center gap-3 pb-2">
                        ...
                        <span>Agregar Tipo de Merma</span>
                    </div>
                </h5>
            </div>
            ...
            <div class="modal-body p-4">
                <form
                    action="/CrearTipoMerma"
                    method="POST"
                >
                    @csrf

                    <!-- Nombre de Tipo de Merma -->
                    <div class="mb-3">
                        <label
                            for="nomTipoMerma"
                        ...
                        >
                            Nombre de Tipo de Merma <span style="color: var(--danger-color);">*</span>
                        </label>
                        <div class="input-group">
                            ...
                            <input
                                ...
                                name="nomTipoMerma"
                                id="nomTipoMerma"
                                placeholder="Nombre de Tipo de Merma"
                                tabindex="1"
                                required
                            >
                        </div>
