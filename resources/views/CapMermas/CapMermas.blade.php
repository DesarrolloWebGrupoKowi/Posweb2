            ...
            <form class="mb-3" id="formMerma" action="/CapMermas">
                <div class="row d-flex justify-content-center">
                    <div class="col-auto mt-2">
                        <label for="idTipoMerma"><strong>Tipo de Merma</strong></label>
                    </div>
                    <div class="col-auto">
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    @if (!empty($idTipoMerma))
                        ...
                        <div class="col-2">
                            ...
                            <input class="form-control shadow" type="number" min="0.10" step="any"
                                name="cantArticulo" id="cantArticulo" placeholder="Cantidad a Mermar" required>
                        </div>
                        <div class="col-5">
                        ...
                        <div class="col-auto">
                            <button id="btnAgregarMerma" class="btn btn-warning btn-sm shadow mt-4">
