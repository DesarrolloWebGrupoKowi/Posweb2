<div
    class="modal fade"
    id="ModalLotes{{ $rostisado->IdDatRosticero }}"
    tabindex="-1"
    aria-labelledby="ModalLotes{{ $rostisado->IdDatRosticero }}"
    aria-hidden="true"
>
    <div
        class="modal-dialog"
        ...
        >
            ...
            <div class="modal-body p-4 pb-0">
                ...
                >
                    ...
                    >
                        {{ number_format($rostisado->CantidadMatPrima, 3) }} kg
                    </span>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table-hover table-custom table-sm table">
                        <thead>
                            <tr>
                                <th class="py-1" style="font-size: 0.75rem;"><i class="bi bi-upc me-1"></i>Lote</th>
                                <th class="py-1" style="font-size: 0.75rem;"><i class="bi bi-calendar me-1"></i>Caducidad</th>
                                <th
                                    class="text-end py-1"
