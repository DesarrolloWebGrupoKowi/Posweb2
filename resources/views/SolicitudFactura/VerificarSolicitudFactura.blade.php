...
<div class="container">
    <form action="/GuardarSolicitudFactura" method="POST" enctype="multipart/form-data">
        ...
        <h2 class="titulo bg-dark text-white mb-3">{{ $nomCliente->NomCliente }}</h2>
        <div class="row mb-3">
            <div class="col-2">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-6">
                <h5 class="titulo card shadow p-1">Seleccione Metódos de Pago a Facturar</h5>
            </div>
        </div>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-3">
                <h5 class="titulo shadow card p-1">Datos del Cliente</h5>
            </div>
        </div>
        <div class="card p-2">
            <div class="row mb-3">
                <div class="col-8">
                    ...
                    <div class="input-group">
                        <div class="input-group-text">
                            <input {!! empty($cliente->Calle) ? 'checked' : '' !!} class="form-check-input mt-0" type="checkbox" id="editCalle" name="chkEdit[]" value="calle">
                        </div>
                ...
                <div class="col-2">
                    ...
                    <div class="input-group">
                        <div class="input-group-text">
                            <input {!! empty($cliente->NumExt) ? 'checked' : '' !!} class="form-check-input mt-0" type="checkbox" id="editNumExt" name="chkEdit[]" value="numExt">
                        </div>
                ...
                <div class="col-2">
                    ...
                    <div class="input-group">
                        <div class="input-group-text">
                            <input class="form-check-input mt-0" type="checkbox" id="editNumInt" name="chkEdit[]" value="numInt">
                        </div>
            ...
            <div class="row mb-3">
                <div class="col-4">
                    ...
                    <div class="input-group">
                        <div class="input-group-text">
                            <input {!! empty($cliente->Colonia) ? 'checked' : '' !!} class="form-check-input mt-0" type="checkbox" id="editColonia" name="chkEdit[]" value="colonia">
                        </div>
                ...
                <div class="col-4">
                    ...
                    <div class="input-group">
                        <div class="input-group-text">
                            <input {!! empty($cliente->Ciudad) ? 'checked' : '' !!} class="form-check-input mt-0" type="checkbox" id="editCiudad" name="chkEdit[]" value="ciudad">
                        </div>
                ...
                <div class="col-4">
                    ...
                    <div class="input-group">
                        <div class="input-group-text">
                            <input {!! empty($cliente->Municipio) ? 'checked' : '' !!} class="form-check-input mt-0" type="checkbox" id="editMunicipio" name="chkEdit[]" value="municipio">
                        </div>
            ...
            <div class="row mb-3">
                <div class="col-4">
                    ...
                    <div class="input-group">
                        <div class="input-group-text">
                            <input {!! empty($cliente->Estado) ? 'checked' : '' !!} class="form-check-input mt-0" type="checkbox" id="editEstado" name="chkEdit[]" value="estado">
                        </div>
                ...
                <div class="col-4">
                    ...
                    <div class="input-group">
                        <div class="input-group-text">
                            <input {!! empty($cliente->CodigoPostal) ? 'checked' : '' !!} class="form-check-input mt-0" type="checkbox" id="editCodigoPostal" name="chkEdit[]" value="codigoPostal">
                        </div>
                ...
                <div class="col-4">
                    ...
                    <div class="input-group">
                        <div class="input-group-text">
                            <input {!! empty($cliente->Email) ? 'checked' : '' !!} class="form-check-input mt-0" type="checkbox" id="editEmail" name="chkEdit[]" value="email">
                        </div>
                        <input type="text" id="email"
                        name="email" class="form-control bg-white"
                        value="{{ empty($cliente->Email) ? old('email') : $cliente->Email }}" required {!! !empty($cliente->Email) ? 'readonly' : '' !!}>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-4">
                    ...
                    <div class="input-group">
                        <div class="input-group-text">
                            <input class="form-check-input mt-0" type="checkbox" id="editTelefono" name="chkEdit[]" value="telefono">
                        </div>
