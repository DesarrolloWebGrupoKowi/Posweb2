        ...
        >
            <div class="p-4 text-center">
                ...
                <h5
                    class="fw-bold mb-2"
                    style="color: #0f172a;"
                >Interfazar Mermas</h5>

                <!-- Mensaje -->
                <p style="color: #64748b; font-size: 0.85rem; margin-bottom: 24px;">¿Estás seguro de interfazar las
                    mermas?</p>
                ...
                <div class="d-flex gap-2">
                    ...
                    <form
                        action="/InterfazarMermas/{{ $idTienda }}/{{ $fecha1 }}/{{ $fecha2 }}"
                        method="POST"
                        class="flex-grow-1"
                    >
                        @csrf
                        ...
                        >
                            <i class="bi bi-check-circle me-1"></i> Interfazar Mermas
                        </button>
                    </form>
                </div>
            </div>
