                    ...
                    >
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                @endphp
                                @php
                                    // Ordenar los tickets por IdTicket descendente
                                    $groupedByTicket = collect($groupedByTicket)
                                        ->sortByDesc(function ($ticket, $ticketId) {
                                            // Se usa ticketInfo->IdTicket si está disponible, sino el ticketId
                                            if (isset($ticket['ticket_info']->IdTicket)) {
                                                return $ticket['ticket_info']->IdTicket;
                                            }
                                            return $ticketId;
                                        })
                                        ->toArray();
                                        ...
                                        <td colspan="12">
                                            ...
                                            {{-- @if ($tieneFactura)
                                                <span
                                                    ...
                                                    solicitud(es)</span>
                                            @endif --}}
                                            - Folio: {{ Hashids::encode($ticketInfo->IdEncabezado) ?? 'N/A' }}
