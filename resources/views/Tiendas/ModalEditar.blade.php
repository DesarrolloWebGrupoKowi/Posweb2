                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="list-group">
                                        ...
                                        <select class="form-select rounded" style="line-height: 18px" name="IdPlaza"
                                            id="IdPlaza">
                            ...
                            <div class="row mt-2">
                                <div class="col-3">
                                    <div class="list-group">
                                        ...
                                        <input class="form-control rounded" style="line-height: 18px" type="text"
                                            name="Colonia" id="Colonia" value="{{ $tienda->Colonia }}"
                                            onkeyup="mayusculas(this)" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="list-group">
                                        ...
                                        <input type="email" name="Correo" id="Correo" class="form-control rounded"
                                            style="line-height: 18px" value="{{ $tienda->Correo }}" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="list-group">
                            ...
                            <div class="row mt-2">
                                <div class="col-3">
                                    <div class="list-group">
                                        ...
                                        <select name="IdCiudad" id="IdCiudad" class="form-select rounded"
                                ...
                                <div class="col-3">
                                    <div class="list-group">
                                        ...
                                        <input type="text" name="Almacen" id="Almacen" class="form-control rounded"
                                            style="line-height: 18px" value="{{ $tienda->Almacen }}"
                                            onkeyup="mayusculas(this)" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="list-group">
                                        ...
                                        <input type="text" name="Organization_Name" id="Organization_Name"
                                            class="form-control rounded" style="line-height: 18px"
                                            value="{{ $tienda->Organization_Name }}" onkeyup="mayusculas(this)"
                                            required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="list-group">
                                        ...
                                        <input type="text" name="Subinventory_Cloud" id="Subinventory_Cloud"
                                            class="form-control rounded" style="line-height: 18px"
                                            value="{{ $tienda->Subinventory_Code }}" onkeyup="mayusculas(this)"
                                            required>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-3">
                                    <div class="list-group">
                                        ...
                                        <select class="form-select rounded" style="line-height: 18px"
                                            name="ServicioaDomicilio" id="ServicioaDomicilio">
                                ...
                                <div class="col-3">
                                    <div class="list-group">
                                        ...
                                        <input class="form-control rounded" style="line-height: 18px" type="number"
                                            name="CostoaDomicilio" id="CostoaDomicilio"
                                ...
                                <div class="col-3">
                                    <div class="list-group">
                                        ...
                                        <input type="text" name="Order_Type_Cloud" id="Oder_Type_Cloud"
                                            class="form-control rounded" style="line-height: 18px"
                                            value="{{ $tienda->Order_Type_Cloud }}" onkeyup="mayusculas(this)"
                                            required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="list-group">
                                        ...
                                        <select class="form-select rounded" style="line-height: 18px"
                                            name="TiendaActiva" id="TiendaActiva">
                                ...
                                <div class="col-3">
                                    <div class="list-group">
                                        ...
                                        <input type="text" name="IdListaPrecios" id="IdListaPrecios"
                                            class="form-control rounded" style="line-height: 18px"
                                            value="{{ $tienda->IdListaPrecios }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
