        ...
        <div class="p-4">
            @if ($devolucionSeleccionada)
                    ...
                    >
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <!-- Layout horizontal: etiquetas en row, valores en row -->
                                <div
                                    class="row g-2 mb-2"
                                    style="font-size: 0.7rem; text-transform: uppercase; font-weight: 600; letter-spacing: 1px; color: #94a3b8;"
                                >
                                    <div class="col-3">Fecha Transacción</div>
                                    <div class="col-3">Estatus</div>
                                    <div class="col-6">Mensaje del Sistema</div>
                                </div>
                                <div
                                    class="row g-2"
                                ...
                                >
                                        ...
                                        @if ($devolucionSeleccionada->Transaction_On)
                                            <span style="color: #475569; font-weight: 500;">
                                                <i
                                                    ...
                                                    style="color: #10b981;"
                                                ></i>
                                                {{ $devolucionSeleccionada->Transaction_On }}
                                            </span>
                                        @else
                                    ...
                                    <div class="col-3">
                                        @if ($status === 'PROCESADO')
                                            <span
                                                class="badge bg-success-subtle text-success border-success-subtle border"
                                                style="font-weight: 500; font-size: 0.8rem; padding: 4px 10px;"
                                            >
                                        ...
                                        @elseif ($status === 'ERROR')
                                            <span
                                                class="badge bg-danger-subtle text-danger border-danger-subtle border"
                                                style="font-weight: 500; font-size: 0.8rem; padding: 4px 10px;"
                                            >
                                    ...
                                    <div class="col-6">
                                        @if ($devolucionSeleccionada->MENSAJE_ERROR)
                                            <span
                                                style="color: {{ $status === 'ERROR' ? '#dc2626' : '#16a34a' }}; font-weight: 500; word-break: break-word;"
                                            >
                                                <i
                                                    class="bi {{ $status === 'ERROR' ? 'bi-exclamation-triangle-fill' : 'bi-check-circle' }} me-1"></i>
                                                {{ $devolucionSeleccionada->MENSAJE_ERROR }}
                                            </span>
                                        @else
                                            <span style="color: #94a3b8;">
                            ...
                            <div class="col-md-6">
                                ...
                                <div
                                    ...
                                    style="font-size: 0.7rem; text-transform: uppercase; font-weight: 600; letter-spacing: 1px; color: #94a3b8;"
                                >
                                    <div class="col-2">Receipt Number</div>
                                    <div class="col-2">Receipt Header ID</div>
                                ...
                                >
                                    ...
                                    <div class="col-2">
                                        @if ($devolucionSeleccionada->ReceiptNumber)
                                            ...
                                            >
                                                <i
                                                    class="bi bi-receipt-cutoff me-1"
                                                    style="color:#10b981;"
                                                ></i>
                                    ...
                                    <!-- Status -->
                                    <div class="col-2">
                                        @if ($devolucionSeleccionada->STATUS_RECEIPT === 'PROCESADO')
                                            <span
                                                class="badge bg-success-subtle text-success border-success-subtle border"
                                        ...
                                        @elseif ($devolucionSeleccionada->STATUS_RECEIPT === 'ERROR')
                                            <span
                                                class="badge bg-danger-subtle text-danger border-danger-subtle border"
                                                style="font-weight:500;font-size:.8rem;padding:4px 10px;"
                                            >
                                    ...
                                    <div class="col-6">
                                        @if ($devolucionSeleccionada->MENSAJE_RECEIPT)
                                            <span
                                                style="color: {{ $devolucionSeleccionada->STATUS_RECEIPT === 'ERROR' ? '#dc2626' : '#16a34a' }}; font-weight:500; word-break:break-word;"
                                            >
                                                <i
                                                    class="bi {{ $devolucionSeleccionada->STATUS_RECEIPT === 'ERROR' ? 'bi-exclamation-triangle-fill' : 'bi-check-circle' }} me-1"></i>

                                                {{ $devolucionSeleccionada->MENSAJE_RECEIPT }}
                                            </span>
                                        @else
                                            <span style="color:#94a3b8;">
                                                <i class="bi bi-dash me-1"></i>Sin mensaje
                ...
                <div
                    ...
                    <div>
                        <h5 class="section-content-title">
                            ...
                            @if ($estatusOracle)
                                <span
                                    class="badge ms-2"
                                    style="background: #fef2f2; color: #dc2626; font-weight: 500; font-size: 0.7rem; padding: 3px 8px; border-radius: 4px;"
                                >
                            ...
                            @else
                                <span
                                    class="badge ms-2"
                                    style="background: #f8fafc; color: #94a3b8; font-weight: 500; font-size: 0.7rem; padding: 3px 8px; border-radius: 4px;"
                                >
                    ...
                    <!-- Botón para actualizar información del detalle -->
                    <button
                        type="button"
                    ...
                    <table class="table-hover table-custom table">
                        <thead>
                            <tr>
                                ...
                                <!-- <th><i class="bi bi-tag me-1"></i>Tipo Ajuste</th> -->
                                <th><i class="bi bi-geo-alt me-1"></i>Almacén</th>
                                <th><i class="bi bi-receipt me-1"></i>Orden Original</th>
                                <th><i class="bi bi-hash me-1"></i>Línea Orig.</th>
                                @if ($estatusOracle)
                                    <th class="text-center"><i class="bi bi-oracle me-1"></i>Estatus Oracle</th>
                                @endif
                            </tr>
                        </thead>
                        <tbody>
                            @forelse ($lineas as $index => $linea)
                                ...
                                <tr>
                                    ...
                                    <td style="font-weight: 500; color: #0f172a;">{{ $linea->Product_Number ?? '-' }}
                                    </td>
                                    <td
                                        class="text-end"
                                        style="color: #475569;"
                                    ...
                                    <td>
                                        @if ($linea->Ordered_UOM)
                                            <span
                                                class="badge"
                                                style="background: #f1f5f9; color: #64748b; font-weight: 500; font-size: 0.75rem; padding: 4px 10px; border-radius: 6px;"
                                            >
                                                {{ $linea->Ordered_UOM }}
                                            </span>
                                        @else
                                    ...
                                    <td>
                                        @if ($linea->Almacen)
                                            <span
                                                class="badge"
                                                style="background: #fefce8; color: #854d0e; font-weight: 500; font-size: 0.75rem; padding: 4px 10px; border-radius: 6px;"
                                            >
                                    ...
                                    <!-- Columna Estatus Oracle -->
                                    @if ($estatusOracle)
                                        <td class="text-center">
                                            @if ($estatusOracleLinea)
                                                @php
                                                    // El campo en Oracle es "status"
                                                ...
                                                @if (str_contains($statusLower, 'awaiting receiving'))
                                                    <span
                                                        class="badge"
                                                        style="background: #eff6ff; color: #1e40af; font-weight: 500; font-size: 0.75rem; padding: 4px 10px; border-radius: 6px;"
                                                    >
                                                        <i
                                                            class="bi bi-hourglass-split me-1"
                                                            style="color: #3b82f6;"
                                                        ></i>Awaiting Receiving
                                                    </span>
                                                ...
                                                @elseif ($statusLower === 'open')
                                                    <span
                                                        class="badge"
                                                        style="background: #f0fdf4; color: #166534; font-weight: 500; font-size: 0.75rem; padding: 4px 10px; border-radius: 6px;"
                                                    >
                                                        <i
                                                ...
                                                @elseif (str_contains($statusLower, 'processing'))
                                                    <span
                                                        class="badge"
                                                        style="background: #f5f3ff; color: #6d28d9; font-weight: 500; font-size: 0.75rem; padding: 4px 10px; border-radius: 6px;"
                                                    >
                                                        <i
                                                    ...
                                                    <!-- Error -->
                                                @elseif (str_contains($statusLower, 'error'))
                                                    <span
                                                        class="badge"
                                                        style="background: #fef2f2; color: #b91c1c; font-weight: 500; font-size: 0.75rem; padding: 4px 10px; border-radius: 6px;"
                                                    >
                                                        <i
                                                ...
                                                @else
                                                    <span
                                                        class="badge"
                                                        style="background: #f8fafc; color: #475569; font-weight: 500; font-size: 0.75rem; padding: 4px 10px; border-radius: 6px;"
                                                    >
                                                        {{ $statusOracle }}
                                                    </span>
                                                @endif
                                ...
                                <tr style="background: #f8fafc; border-top: 2px solid #e2e8f0;">
                                    ...
                                    >
                                        <div class="d-flex justify-content-end align-items-center gap-3">
                                            ...
                                            <span style="color: #94a3b8;">|</span>
                                            <span
                                                style="color: #64748b; font-size: 0.85rem; font-weight: 500;">Total:</span>
