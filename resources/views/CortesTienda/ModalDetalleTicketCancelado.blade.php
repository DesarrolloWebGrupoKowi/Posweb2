<div class="modal fade" data-bs-backdrop="static" id="ModalDetalleTicket{{ $ticket->IdEncabezado}}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
