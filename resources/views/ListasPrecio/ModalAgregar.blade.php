            ...
            <div class="modal-body">
                <form action="/CrearListaPrecio" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="NomListaPrecio" name="NomListaPrecio" class="form-control rounded"
                            onkeyup="mayusculas(this)" required>
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Peso Minimo</label>
                        <input class="form-control rounded" type="number" name="PesoMinimo" id="PesoMinimo"
                            step="0.01" required>
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Peso Maximo</label>
                        <input class="form-control rounded" type="number" name="PesoMaximo" id="PesoMaximo"
                            step="0.01" required>
                    </div>
                    <div class="mb-3">
