    ...
    <div class="container-fluid width-95 d-flex flex-column gap-4 pt-4">
        ...
        >
            ...
            <form
                ...
                action="/ReporteRosticeroAdmin"
                method="GET"
            >
                <input
                    type="hidden"
                    class="idPagination"
                    value="&idTienda={{ $idTienda }}"
                >
                <input
                    type="hidden"
                    class="idPagination"
                    value="&fecha1={{ empty($fecha1) ? date('Y-m-d') : $fecha1 }}"
                >
                <input
                    type="hidden"
                    class="idPagination"
                    value="&fecha2={{ empty($fecha2) ? date('Y-m-d') : $fecha2 }}"
                >
                <div class="col-auto">
                    <select
            ...
            <table>
                ...
                <tbody>
                    ...
                    @foreach ($concentrado as $tConcentrado)
                        @php
                            $cantiadad = $tConcentrado->Detalle->sum('Cantidad');
                        @endphp
                        <tr>
