...
@section('title', 'Concentrado por Tienda y Familia')
    ...
    <div class="container-fluid width-general d-flex flex-column gap-4 pt-4">
        ...
        <div class="card border-0 p-4" style="border-radius: 10px">
            <div class="d-flex justify-content-sm-between align-items-sm-end flex-column flex-sm-row">
                @include('components.title', ['titulo' => 'Concentrado por Tienda y Familia'])
                <div class="d-flex gap-2">
                    <form class="d-flex align-items-center justify-content-end flex-wrap pb-0 gap-2"
                        action="/ReporteConcentradoPorTiendaYFamilia" method="GET">
                        <div class="col-auto">
                    ...
                    {{-- <form action="/ExportReporteConcentradoPorTiendaYFamilia" method="GET">
