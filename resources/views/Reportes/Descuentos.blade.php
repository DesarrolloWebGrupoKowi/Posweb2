                ...
                >
                    <div class="col-md-2">
                        <label
                            class="form-label fw-medium mb-2"
                            style="color: var(--text-secondary); font-size: 0.85rem;"
                        ><i class="bi bi-folder me-1"></i>Grupo</label>
                        <select
                            name="id_grupo"
                            class="form-select"
                            style="border-radius: 8px; border: 1px solid var(--border-input); padding: 8px 12px; font-size: 0.85rem;"
                    ...
                    <div class="col-md-2">
                        <label
                            class="form-label fw-medium mb-2"
                            style="color: var(--text-secondary); font-size: 0.85rem;"
                        ><i class="bi bi-folder-symlink me-1"></i>Familia</label>
                        <select
                            name="id_familia"
                            class="form-select"
                            style="border-radius: 8px; border: 1px solid var(--border-input); padding: 8px 12px; font-size: 0.85rem;"
                    ...
                    <div class="col-md-2">
                        <label
                            class="form-label fw-medium mb-2"
                            style="color: var(--text-secondary); font-size: 0.85rem;"
                        ><i class="bi bi-hash me-1"></i>ID Descuento</label>
                        <input
                            type="text"
                    ...
                    <div class="col-md-2">
                        <label
                            class="form-label fw-medium mb-2"
                            style="color: var(--text-secondary); font-size: 0.85rem;"
                        ><i class="bi bi-tag me-1"></i>Nombre Descuento</label>
                        <input
                            type="text"
                            name="nom_descuento"
                            class="form-control"
                ...
                <div class="col-xl-3 col-md-6 col-12">
                    ...
                    >
                        ...
                        <div style="position: relative; z-index: 1;">
                            ...
                            <span style="color: var(--kpi-sub-color); font-size: 0.78rem;">Suma (Cant × Precio
                                Lista)</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-md-6 col-12">
                    ...
                    >
                        ...
                        <div style="position: relative; z-index: 1;">
                            ...
                            <span style="color: var(--kpi-sub-color); font-size: 0.78rem;">Lo que ahorraron los
                                clientes</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-md-6 col-12">
                    ...
                    >
                        ...
                        <div style="position: relative; z-index: 1;">
                            ...
                            <span style="color: var(--kpi-sub-color); font-size: 0.78rem;">Sobre el total de
                                ventas</span>
                        </div>
                    </div>
                </div>
                ...
                <table class="table-hover table-custom table">
                    ...
                    <tbody>
                        ...
                        @forelse ($data as $item)
                            <tr>
                                <td><span>{{ $item->NomDescuento }}</span></td>
                                <td style="font-weight: 500;">{{ $item->NomTienda }}</td>
                                <td style="font-size: 0.85rem;">{{ $item->FechaVenta }}</td>
                                <td style="font-weight: 600; color: var(--text-primary);">{{ $item->CodArticulo }}
                                </td>
                                <td
                                    class="text-truncate"
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        <small
                                            style="color: var(--danger-color); text-decoration: line-through; font-size: 0.75rem;"
                                        >${{ number_format($item->PrecioLista, 2) }}</small>
                                        <span
                                            style="color: var(--success-color); font-weight: 600; font-size: 0.85rem;"
                                        >${{ number_format($item->PrecioArticulo, 2) }}</span>
                                    </div>
                                </td>
                                <td
                                    class="text-end"
