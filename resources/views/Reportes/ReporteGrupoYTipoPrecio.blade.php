            ...
            <div class="d-flex flex-wrap gap-3">
                ...
                >
                    ...
                    <div style="position: relative; z-index: 1;">
                        ...
                        <span
                            style="color: var(--kpi-sub-color); font-size: 0.75rem;">{{ number_format($kilos['MENUDEO'], 2) }}
                            kg</span>
                    </div>
                </div>
                ...
                >
                    ...
                    <div style="position: relative; z-index: 1;">
                        ...
                        <span
                            style="color: var(--kpi-sub-color); font-size: 0.75rem;">{{ number_format($kilos['MINORISTA'], 2) }}
                            kg</span>
                    </div>
                </div>
                ...
                >
                    ...
                    <div style="position: relative; z-index: 1;">
                        ...
                        <span
                            style="color: var(--kpi-sub-color); font-size: 0.75rem;">{{ number_format($kilos['EMPYSOC'], 2) }}
                            kg</span>
                    </div>
                </div>
        ...
        <div class="p-4">
            <div class="d-flex flex-column flex-lg-row justify-content-lg-between align-items-lg-center mb-3 gap-3">
                <div>
                    ...
                    <p class="section-content-subtitle">Listado de ventas agrupadas por grupo y tipo de precio</p>
                </div>
            </div>
