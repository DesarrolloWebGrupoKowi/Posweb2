...
<div class="container-fluid">
    <table id="customers" class="table table-co table-sm table-striped shadow caption-top">
        ...
        <tbody>
            @if ($clienteAlta == 1)
            <tr>
                <td colspan="12"><i style="color: red" class="fa fa-exclamation-triangle"></i> No se Ha Dado de Alta el
                    Cliente en Oracle!</td>
            </tr>
            @else
            @foreach ($clientesOracle as $clienteOracle)
            <form action="LigarCliente">
                <input type="hidden" name="idSolicitudFactura" value="{{ $solicitudFactura->IdSolicitudFactura }}">
    ...
    <div class="row mb-3 d-flex justify-content-center">
        <button class="col-auto btn btn-warning" data-bs-toggle="modal" data-bs-target="#ModalConfirmarLigueCliente">
